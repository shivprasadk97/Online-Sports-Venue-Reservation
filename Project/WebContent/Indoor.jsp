...
<body>
	...
	<div class="card row">
		<form method="Get" action="IndoorServlet">
			<div class="col-sm-6">
				<img class="card-img-top" src="images/clip3.jpg" alt="Card image"
					style="margin-left: 20px; padding: 10px; width: 600px; height: 400px">
				<div class="card-body">
					<button style="margin-left: 20px; padding: 10px;" type="submit"
						name="name" value="basketball">Basketball</button>
				</div>
			</div>
		</form>
		<form method="Get" action="IndoorServlet">
			<div class="col-sm-6">
				<img class="card-img-top" src="images/clip4.jpg" alt="Card image"
					style="padding: 10px; width: 600px; height: 400px">
				<div class="card-body">
					<button style="padding: 10px;" type="submit" name="name"
						value="badminton">Badminton</button>
				</div>
			</div>
		</form>
